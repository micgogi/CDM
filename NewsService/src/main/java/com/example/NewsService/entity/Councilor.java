...
public class Councilor {
  @EmbeddedId private CouncilorIdentity councilorIdentity;
  ...
  public String toString() {
    return "Councilor [councilorIdentity="
        + councilorIdentity
        + ", name="
        + name
        + ", url="
  ...
  public boolean equals(Object obj) {
    ...
    if (councilorIdentity == null) {
      if (other.councilorIdentity != null) return false;
    } else if (!councilorIdentity.equals(other.councilorIdentity)) return false;
    if (name == null) {
